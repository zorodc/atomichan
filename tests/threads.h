#ifndef THREADS_H
#define THREADS_H
/// Originally by John Tsiombikas. Modified slightly by Daniel Collins, to abate a compiler warning, and use the built-in C11 library, when it is available.
/// I place it in the public domain.

#ifndef __STDC_NO_THREADS__
// Use the system library if it is available.
#include <threads.h>
#else  // Implementation using pthreads, pulled from J. Tsiombikas's c11threads.h
